<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true" CodeFile="DLG_HtmlEditor.aspx.cs" Inherits="Job_DLG_HtmlEditor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/DLG_HtmlEditor.js" type="text/javascript"></script>
            ...
            <dx:ASPxHtmlEditor ID="ASPxctlHTML" runat="server" Width="100%" ClientInstanceName="ctlHTML"
                ...
                <SettingsDialogs>
                    <InsertImageDialog ShowMoreOptionsButton="False">
                        <SettingsImageUpload UploadFolderUrlPath="~/Files/DxHtmlEditor/temp">
                            <FileSystemSettings UploadFolder="~/Files/DxHtmlEditor/temp" />
                        </SettingsImageUpload>
                        <SettingsImageSelector>
                            <EditingSettings TemporaryFolder="~/Files/DxHtmlEditor/temp" />
                        </SettingsImageSelector>
                    </InsertImageDialog>
                </SettingsDialogs>
            </dx:ASPxHtmlEditor>
