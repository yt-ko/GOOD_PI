    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { header: "상태", name: "astat", width: 60, align: "center", hidden: true },
                ...
                { header: "납품가능량", name: "plan_qty", width: 70, align: "right", mask: "numeric-int" },
                { header: "납품일자", name: "dlv_date", width: 80, align: "center", mask: "date-ymd" },
                { header: "적기납품", name: "dlv_qty", width: 60, align: "right", mask: "numeric-int" },
