...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_MAIN", query: (v_global.logic.Supp ? "SRM_4150_1_SUPP" : "SRM_4150_1"), title: "집계",
            height: 100, show: true, selectable: true, number: true,
            element: [
				{ header: "사업부", name: "plant_nm", width: 120, align: "center" },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_SUB", query: (v_global.logic.Supp ? "SRM_4150_2_SUPP" : "SRM_4150_2"), title: "상세",
            height: 300, show: true, selectable: true, number: true, dynamic: true,
            element: [
				{ header: "사업부", name: "plant_nm", width: 60, align: "center" },
				...
				{ header: "입고금액", name: "io_amt", width: 80, align: "right", mask: "numeric-int" },
				{ header: "매입금액", name: "in_amt", width: 80, align: "right", mask: "numeric-int" },
				{ header: "미매입금액", name: "not_in_amt", width: 80, align: "right", mask: "numeric-int" },
