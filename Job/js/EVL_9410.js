...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                { header: "평가명", name: "evl_nm", width: 120 },
                { header: "평가그룹", name: "evl_group_nm", width: 80 },
                { header: "장비군", name: "dept_area_nm", width: 80 },
                { header: "평가자", name: "valuer_nm", width: 80 },
                { header: "평가대상", name: "user_nm", width: 150 },
                { header: "평가점수<br />(가중치)", name: "total_add_point", width: 80, align: "right", mask: "numeric-int" },
                { header: "평가등급<br />(가중치)", name: "total_add_grade", width: 80, align: "center" },
                { header: "개선항목<br />(건)", name: "imprv_cnt", width: 80, align: "right", mask: "numeric-int" },
                { header: "개선완료항목<br />(건)", name: "plan_cnt", width: 80, align: "right", mask: "numeric-int" },
                { header: "개선율<br />(%)", name: "plan_rate", width: 80, align: "right", mask: "numeric-int" },
                { header: "점검항목<br />(건)", name: "result_cnt", width: 80, align: "right", mask: "numeric-int" },
                { header: "적합율<br />(%)", name: "result_rate", width: 80, align: "right", mask: "numeric-int" },
