...
var gw_job_process = {
    ...
    ready: function () {
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        //----------
        var args = { type: "PAGE", page: "RNS_2011", title: "SOP 등록/개정", width: 1000, height: 630 };
        gw_com_module.dialoguePrepare(args);
        //----------
        var args = { type: "PAGE", page: "RNS_2012", title: "SOP 상세보기", width: 1000, height: 630 };
        gw_com_module.dialoguePrepare(args);
        //----------
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_MAIN", query: "RNS_2010_1", title: "SOP",
                ...
                case "협력사":
                    {
                        ...
                        // 확면 리프레시 하지 않을 경우 대비하여 최종 정보 가져오기
                        var rns = getRNS({
