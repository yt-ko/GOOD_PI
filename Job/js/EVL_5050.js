...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                    {
                        element: [
                            {
                                name: "evl_nm1", label: { title: "평가 :" }, mask: "search",
                    ...
                    },
                    {
                        element: [
                            {
                                name: "user_nm1", label: { title: "평가대상1 :" }, mask: "search",
                    ...
                    },
                    {
                        element: [
                            {
                                name: "user_nm2", label: { title: "평가대상2 :" }, mask: "search",
                                editable: { type: "text", size: 20 }
                            },
                            { name: "user_id2", hidden: true }
                        ]
                    },
                    {
                        element: [
                            {
                                name: "user_nm3", label: { title: "평가대상3 :" }, mask: "search",
                                editable: { type: "text", size: 20 }
                            },
                            { name: "user_id3", hidden: true }
                        ]
                    },
                    {
                        align: "right",
        ...
        //=====================================================================================
        var args = {
            targetid: "lyrChart_1", query: "EVL_5050_1",
            show: true,
            format: {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_1", query: "EVL_5050_2", title: "개선현황",
        ...
        //=====================================================================================
        var args = {
            targetid: "lyrChart_2", query: "EVL_5050_3",
            show: true,
            format: { view: "8" },
            control: {
                by: "DX",
        ...
        //=====================================================================================
        var args = {
            targetid: "lyrChart_3", query: "EVL_5050_4",
            show: true,
            format: { view: "8" },
            control: {
                by: "DX",
        ...
        //=====================================================================================
        var args = {
            targetid: "lyrChart_4", query: "EVL_5050_5",
            show: true,
            format: {
                view: "1", rotate: "0", reverse: "0"
            },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_2", query: "EVL_5050_6", title: "개선항목",
    ...
    var args = {
        source: {
            ...
            element: [
                ...
                { name: "user_id2", argument: "arg_user_id2" },
                { name: "user_id3", argument: "arg_user_id3" }
            ],
            remark: [
                //{ infix: ",", label: "평가 :", element: [{ name: "evl_nm1" }, { name: "evl_nm2" }] }
                { element: [{ name: "evl_nm1" }] },
                { element: [{ name: "user_nm1" }] },
                { element: [{ name: "user_nm2" }] },
                { element: [{ name: "user_nm3" }] }
            ]
        },
        target: [            
