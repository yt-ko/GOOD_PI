...
var gw_job_process = {
        ...
        var args = {
            request: [
				...
				{  type: "INLINE", name: "통계유형",
				    data: [
						{ title: "Down Time", value: "TIME" },
						{ title: "Down 횟수", value: "COUNT" }
					]
				}
			],
            starter: start
    ...
    UI: function () {
        ...
        //==== Main Grid
        var args = { targetid: "grdData_Main", query: "EOM_5130_M_1", title: "분류별",
            caption: true, width: 370, height: 299, pager: false, show: true,
            element: [
				{ header: "분류명", name: "category", width: 165, align: "center" },
				{ header: "Down횟수", name: "value1", width: 60, align: "center" },
				{ header: "DownTime", name: "value2", width: 60, align: "center" },
        ...
        //==== Main Chart
        var args = { targetid: "lyrChart_Main", query: "EOM_5130_M_1", title: "분류별", show: true,
        ...
        //==== Sub Grid
        var args = { targetid: "grdData_Sub", query: "EOM_5130_S_1", title: "상세분류별",
            caption: true, width: 370, height: 299, pager: false, show: true,
            element: [
				{ header: "상세분류", name: "category", width: 165, align: "center" },
				{ header: "Down횟수", name: "value1", width: 60, align: "center" },
				{ header: "DownTime", name: "value2", width: 60, align: "center" },
				{ name: "rcode", hidden: true },
				{ name: "ymd_fr", hidden: true },
        ...
        //==== Sub Chart
        var args = { targetid: "lyrChart_Sub", query: "EOM_5130_S_1", title: "상세분류별", show: true,
            format: { view: "1", rotate: "0", reverse: "1" },
