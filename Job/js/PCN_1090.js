                ...
                row: [
                    {
                        element: [
                            ...
                            { name: "dept_area", format: { type: "text", width: 166 } },
...
function processRetrieveEnd(param) {
    ...
    // processRetrieve 에서 처리되지 않은 문제 해결을 위함 2021.05.14 by JJJ
    gw_com_api.setValue("frmData_MEMO1", "selected", "chg_memo1", gw_com_api.getValue("frmData_MAIN", "selected", "chg_memo1"));
    gw_com_api.setValue("frmData_MEMO2", "selected", "chg_memo2", gw_com_api.getValue("frmData_MAIN", "selected", "chg_memo2"));
    gw_com_api.setValue("frmData_MEMO3", "selected", "chg_memo3", gw_com_api.getValue("frmData_MAIN", "selected", "chg_memo3"));
