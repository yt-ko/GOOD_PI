...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            border: true, show: true, margin: 250, remark: "lyrRemark",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_코드", query: "w_iscm1010_M_1", title: "고객사 공정 정보",
            height: 442, show: true, selectable: true, number: true,
            editable: { master: true, bind: "select", focus: "cust_cd", validate: true },
            element: [
				{
				    header: "고객사", name: "cust_cd", width: 170, align: "center",
				    format: { type: "select", data: { memory: "고객사" } },
				    editable: { bind: "create", type: "select", data: { memory: "고객사" } }
				},
				{
				    header: "Line", name: "cust_line", width: 170, align: "center",
				    format: { type: "select", data: { memory: "LINE" } },
				    editable: { bind: "create", type: "select", data: { memory: "LINE" } }
				},
				{
				    header: "Process", name: "cust_process", width: 170, align: "center",
				    format: { type: "select", data: { memory: "PROCESS" } },
				    editable: { bind: "create", type: "select", data: { memory: "PROCESS" } }
				},
				{
				    header: "고객사담당자", name: "cust_man_nm", width: 170, align: "center",
				    editable: { type: "text" }
				},
				{
    ...
    procedure: function () {
        ...
        function click_lyrMenu_추가(ui) {
            ...
            var args = { targetid: "grdData_코드", edit: true };
        ...
        function click_lyrMenu_삭제(ui) {
            ...
            var args = { targetid: "grdData_코드", row: "selected" }
        ...
        case "cust_cd":
            {
                gw_com_api.filterSelect(
                    ...
                    {
                        memory: "LINE", unshift: [{ title: "-", value: "" }],
                        by: [{ source: { id: param.object, row: param.row, key: param.element, grid: true } }]
                    }, true);
            }
            break;
    }
