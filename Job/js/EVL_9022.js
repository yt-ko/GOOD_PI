                    ...
                    },
                    {
                        element: [
                            { header: true, value: "평가문항", format: { type: "label" } },
                            {
                                ...
                                editable: { type: "textarea", rows: 10, maxlength: 500, validate: { rule: "required", message: "평가문항" } }
                            }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "설명", format: { type: "label" } },
                            {
                                ...
                                editable: { type: "textarea", rows: 10, maxlength: 500, validate: { rule: "required", message: "설명" } }
                            },
                            { name: "evl_no", editable: { type: "hidden" }, hidden: true },
                            { name: "item_seq", editable: { type: "hidden" }, hidden: true },
                            { name: "evl_group", editable: { type: "hidden" }, hidden: true },
