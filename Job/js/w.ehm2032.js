    ...
    ready: function () {
        ...
        var args = {
            request: [
                ...
                {
                    type: "PAGE", name: "현상분류", query: "dddw_zcoded_all",
                    param: [
                        { argument: "arg_hcode", value: "IEHM21" }
                    ]
                },
				{
				    type: "PAGE", name: "현상구분", query: "dddw_zcoded_all",
				    param: [
                        { argument: "arg_hcode", value: "IEHM31" }
                    ]
				},
				{
				    type: "PAGE", name: "원인부위분류", query: "dddw_zcoded_all",
				    param: [
                        { argument: "arg_hcode", value: "IEHM22" }
                    ]
				},
                {
                    type: "PAGE", name: "원인부위구분", query: "dddw_zcoded_all",
                    param: [
                        { argument: "arg_hcode", value: "IEHM32" }
                    ]
                },
				{
				    type: "PAGE", name: "원인분류", query: "dddw_zcoded_all",
				    param: [
                        { argument: "arg_hcode", value: "IEHM23" }
                    ]
				},
				{
				    type: "PAGE", name: "원인구분", query: "dddw_zcoded_all",
				    param: [
