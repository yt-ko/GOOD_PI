...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //2021-05-18 by KYT
        var args = {
            targetid: "grdData_첨부파일", query: "SYS_File_Edit", title: "첨부 파일",
    ...
    procedure: function () {
        ...
        function click_lyrMenu_3_추가(ui) {
            ...
            var dataKey = gw_com_api.getValue("grdData_현황", "selected", "setup_no", true);   // Main Key value for Search
            var dataSeq = gw_com_api.getValue("grdData_현황", "selected", "str_ymd", true);   // Main Seq value for Search
...
function processLink(param) {
    ...
    gw_com_module.objRetrieve(args);
    processFileList({ data_key: gw_com_api.getValue("grdData_현황", "selected", "setup_no", true) });
}
//2021-05-18 by KYT
function processFileList(param) {
    ...
    var objID = (param.obj_id == undefined) ? "grdData_첨부파일" : param.obj_id; // Set File Data Type
