    ...
    ready: function () {
        ...
        var args = {
            request: [
                ...
                {
                    type: "PAGE", name: "AS-현상분류", query: "DDDW_CM_CODED_A",
                    param: [
                        { argument: "arg_hcode", value: "IEHM21" }
                    ]
                },
				{
				    type: "PAGE", name: "AS-현상구분", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IEHM31" }
                    ]
				},
				{
				    type: "PAGE", name: "AS-부위분류", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IEHM22" }
                    ]
				},
                {
                    type: "PAGE", name: "AS-부위구분", query: "DDDW_CM_CODED_A",
                    param: [
                        { argument: "arg_hcode", value: "IEHM32" }
                    ]
                },
				{
				    type: "PAGE", name: "AS-원인분류", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IEHM23" }
                    ]
				},
				{
				    type: "PAGE", name: "AS-원인구분", query: "DDDW_CM_CODED_A",
				    param: [
				...
				{
				    type: "PAGE", name: "PM-부위분류", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IPOP32" }
                    ]
				},
				{
				    type: "PAGE", name: "PM-원인분류", query: "DDDW_CM_CODED_A",
				    param: [
                ...
                {
                    type: "PAGE", name: "QC-현상분류", query: "DDDW_CM_CODED_A",
                    param: [
                        { argument: "arg_hcode", value: "IQDM21" }
                    ]
                },
				{
				    type: "PAGE", name: "QC-현상구분", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IQDM31" }
                    ]
				},
				{
				    type: "PAGE", name: "QC-부위분류", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IQDM22" }
                    ]
				},
                {
                    type: "PAGE", name: "QC-부위구분", query: "DDDW_CM_CODED_A",
                    param: [
                        { argument: "arg_hcode", value: "IQDM32" }
                    ]
                },
				{
    ...
    var args = {
        source: {
            ...
            argument: [
                {
                    name: "arg_issue_part",
                    value: gw_com_api.getValue("frmOption", 1, "issue_part")
                }
			],
            remark: [
	            {
