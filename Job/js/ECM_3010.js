        ...
        case "삭제":
            {
                ...
                if (param.object == "lyrMenu") {
                    ...
                    args = { object: "grdData_FileA", element: "file_id" };
                }
...
function processRetrieve(param) {
    ...
    if (param.object == "grdList_MAIN") {
        args = {
            source: {
                ...
                element: [
                    { name: "result_id", argument: "arg_data_key" }
                ]
            },
            target: [
    ...
    //if (gw_com_api.getValue("grdList_MAIN", "selected", "result_id", true) != "") {
    //    
    //}
