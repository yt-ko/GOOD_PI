...
var gw_job_process = {
    ...
    uiButton: function () {
        ...
        //------ Create Buttons : lyrMenu : 조회, 추가, 저장, 삭제, 엑셀, 닫기
        var args = {
        ...
        //------ Create Buttons : lyrMenu_File1 : 추가, 삭제
        var args = {
    ...
    //    var args = {
    //        targetid: "grdData_FileA", query: "EOM_2200_F_1", title: "첨부 문서",
...
function processFileUpload(param) {
 ...
 //   };
    ...
    var dataType = "EOM-DOWN"; 
    var dataKey = gw_com_api.getValue("frmData_Sub", 1, "issue_id");
    var dataSeq = -1;
    var biz_area = '연구';

    v_global.event.data = { data_tp: dataType, data_key: dataKey, data_seq: dataSeq, file_group2: biz_area}
...
//---------- 파일 리스트 조회
//del by kyt 2021-06-03 (processFileList 대채)
//function processFileList(param) {
//    var DataKey = gw_com_api.getValue("frmData_Sub", "1", "data_key", false) ;
//    var DataSeq = -1;
//    var args = { 
...
streamProcess = function (param) {
    ...
    switch (param.ID) {
        ...
        case gw_com_api.v_Stream.msg_resultMessage: { 
            if (param.data.page == "SYS_FileUpload" && param.data.ID == gw_com_api.v_Message.msg_informSaved) {
                closeDialogue({ page: "SYS_FileUpload" });
        		processFileList({}) ;
			}
