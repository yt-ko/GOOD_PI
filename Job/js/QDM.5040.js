...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                    {
                        element: [
                            ...
                            { name: "value_tp", label: { title: "집계기준 :" }, value: "C",
                                editable: { type: "select", 
                                	data: { memory: "집계기준" }
                                }
                            }
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "EHM_5040_M_1", title: "부품 교체 현황",
            height: 201,
            show: true,
            dynamic: true,
            key: true,
        ...
        //=====================================================================================
        var args = { targetid: "lyrChart_현황", query: "EHM_5040_S_1",
            show: true,
            format: {
    ...
    var args = {
        source: {
            ...
            element: [
                ...
                { name: "value_tp", argument: "arg_value_tp" },
				{
				    name: "ymd_fr",
				    argument: "arg_ymd_fr"
				},
