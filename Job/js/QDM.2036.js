    ...
    ready: function () {
        ...
        var args = {
            request: [
				...
				{
				    type: "PAGE", name: "AS-교체구분", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IEHM12" }
                    ]
				},
				{
				    type: "PAGE", name: "AS-부품상태", query: "DDDW_CM_CODE",
				    param: [
                        { argument: "arg_hcode", value: "IEHM40" }
                    ]
				},
				{
				    type: "PAGE", name: "AS-부품군", query: "DDDW_CM_CODE",
				    param: [
				...
				{
				    type: "PAGE", name: "PM-교체분류", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IPOP12" }
                    ]
				},
				{
				    type: "PAGE", name: "PM-교체구분", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IEHM12" }
                    ]
				},
				...
				{
				    type: "PAGE", name: "QC-교체구분", query: "DDDW_CM_CODED_A",
				    param: [
                        { argument: "arg_hcode", value: "IEHM12" }
                    ]
				},
