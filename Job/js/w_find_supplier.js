...
processRetrieve = function (param) {
    ...
    */
    ...
    var args = {
        ...
        target: [
			{
			    query: (v_global.data.system == "PLM") ? "w_find_supplier_M_2" : "w_find_supplier_M_1",
			    type: "GRID",
			    id: "grdData_협력사",
			    focus: true,
			    select: true
...
function informResult() {
    ...
    var args = {
        ...
        data: {
            ...
            biz_no: gw_com_api.getValue("grdData_협력사", "selected", "rgst_no", true)
        }
    };
    gw_com_module.streamInterface(args);
