        ...
        var args = {
            request: [
                ...
                },
                {
                    ...
                    param: [{ argument: "arg_type", value: "dddw_deptarea_part" }]
                }
            ],
            starter: start
        };
        ...
        var args = {
            ...
            element: [
                ...
                },
                {
                    ...
                    editable: { type: "text", maxlength: 200, validate: { rule: "required", message: "Email" } }
                },
                {
    ...
    procedure: function () {
        ...
        function processButton(param) {
            ...
            switch (param.element) {
                ...
                case "요소":
                    {
                        var args = { menu_id: "EVL_1020", frame: true };
