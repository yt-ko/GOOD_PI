...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            height: 150, show: true, caption: true, selectable: true, number: true, key: true, pager: true,
            element: [
                ...
                { header: "미개선", name: "bal_cnt", width: 70, mask: "numeric-int", align: "right" },
                { header: "완료", name: "plan_cnt", width: 70, mask: "numeric-int", align: "right" },
                { header: "개선율", name: "plan_rate", width: 70, mask: "numeric-float1", align: "right" },
                { header: "적합", name: "result_cnt", width: 70, mask: "numeric-int", align: "right" },
                { header: "적합율", name: "result_rate", width: 70, mask: "numeric-float1", align: "right" },
                ...
                case "result_rmk":
                    {
                        var args = {
                            ...
                            handler: function (param) {
                                ...
                                gw_com_api.setCRUD(param.object, param.row, "retrieve", (param.type == "GRID"));
                            },
                            param: param
                        }
                        processSave(args);
        ...
        function processRowselected(param) {
            ...
            if (param.object == "grdData_EVL_USER")
                ...
                if (v_global.process.prev.row != null && v_global.process.prev.row != undefined) {
                    // row 이동 시 기존 row editable = false
                    var args = {
