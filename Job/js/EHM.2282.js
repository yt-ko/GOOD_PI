...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_MAIN", query: "EHM_2282_1", title: "코드 내역",
            ...
            element: [
                {
                    header: "코드", name: "dcode", width: 120,
                ...
                { name: "rcode", editable: { type: "hidden" }, hidden: true },
                { name: "fcode1", editable: { type: "hidden" }, hidden: true },
                {
...
function processItemchanged(param) {
    ...
    if (param.element == "dcode")
        gw_com_api.setValue(param.object, param.row, "rcode", param.value.current, (param.type == "GRID"));
...
function processInsert(param) {
    ...
    var args = {
        ...
        data: [
            { name: "hcode", value: "IEHM94" },
            { name: "use_yn", value: "1" },
            { name: "sort_seq", rule: "INCREMENT", value: 1 },
            { name: "fcode1", value: "1" }  // 공급사여부
        ]
    };
