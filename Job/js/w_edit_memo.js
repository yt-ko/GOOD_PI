...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            scroll: false, show: false, selectable: true,
                ...
                row: [
                    {
                        element: [
                            {
                                name: "memo_text",
                                format: { type: "textarea", rows: 34, width: 734 },
                                editable: { type: "textarea", rows: 34, width: 734 }
                            }
                        ]
                    }
                ]
...
function setObject(param) {
    ...
    if (param.edit) {
        ...
        if (param.rows != undefined) {
            $("#" + getObject({}) + "_memo_text").attr("rows", param.rows);
        }
        if (param.maxlength != undefined) {
            $("#" + getObject({}) + "_memo_text").attr("maxlength", param.maxlength);
        }
        ...
        if (param.rows != undefined) {
            $("#" + getObject({}) + "_memo_text_view").attr("rows", param.rows);
        }
        gw_com_api.show(getObject({}));
