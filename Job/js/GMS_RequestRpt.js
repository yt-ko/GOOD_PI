...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            tabid: "lyrFrame",
            target: [
                { type: "PAGE", id: "GMS_RequestList", title: "Help Service 현황", launch: true, handler: clickTabPage },   //tabselect Event handler
                { type: "PAGE", id: "GMS_RequestEdit", title: "help Service 등록" }
            ]
