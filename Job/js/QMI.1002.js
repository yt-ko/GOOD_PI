...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //2021-05-13 KYT
        var args = {
            targetid: "grdData_FILE", query: "SYS_File_Edit", title: "첨부 파일",
            ...
            element: [
                ...
                { header: "등록자", name: "usr_nm", width: 70, align: "center" },
...
function processFile(param) {
    ...
    if (param.object == "grdData_FILE") {
        ...
        var dataType = "QMI";    // Set File Data Type
        var dataKey = gw_com_api.getValue("frmData_MASTER", 1, "qmi_key") == "" ? null : gw_com_api.getValue("frmData_MASTER", 1, "qmi_key");   // Main Key value for Search
