...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Grid : Main ====
        var args = { targetid: "grdData_Main", query: "EOM_2162_M_1", title: "예약 내역",
            ...
            element: [
				...
				{ header: "담당자", name: "plan_user_nm", width: 70, align: "center" },
				{ header: "예약일자", name: "fr_date", width: 70, align: "center", mask: "date-ymd" },
				{ header: "시작시각", name: "fr_time", width: 60, align: "center", mask: "time-hm" },
				{ header: "종료시각", name: "to_time", width: 60, align: "center", mask: "time-hm" },
