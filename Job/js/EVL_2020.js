                ...
                case "취소":
                    {
                        ...
                        var p = {
                            ...
                            param: {
                                evl_no: gw_com_api.getValue("grdData_EVL_RESULT", 1, "evl_no", true),
                                evl_seq: gw_com_api.getValue("grdData_EVL_RESULT", 1, "evl_seq", true),
                                user_id: gw_com_api.getValue("grdData_EVL_RESULT", 1, "user_id", true),
