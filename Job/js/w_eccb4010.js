...
var gw_job_process = {
    ...
    uiButton: function () {
        ...
        //---------- Create Buttons : lyrMenu : 결재상신, 중단, 중단취소, 추가, 저장, 삭제, 닫기
        var args = {
            targetid: "lyrMenu",
            type: "FREE",
            element: [
        ...
        //---------- Create Buttons : lyrMenu_도면 : 추가, 삭제
        var args = {
       ...
       //---------- Create Buttons : lyrMenu_PJT : 추가, 삭제
        var args = {
       ...
       //---------- Create Buttons : lyrMenu_첨부 : 추가, 삭제, 저장
        var args = {
    ...
    uiData: function () {
       ...
       //--------- Data Box : frmData_메모F : 개선 사항
        ...
        //--------- Data Box : grdData_ACT : Action Item
        var args = {
    ...
    uiEvent: function () {
        ...
        //----------
        var args = { targetid: "lyrMenu", element: "미리보기", event: "click", handler: processPreview };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "통보", event: "click", handler: processMail };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "상신", event: "click", handler: processApprove };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "중단", event: "click", handler: processStop };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "취소", event: "click", handler: processCancel };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "추가", event: "click", handler: processAdd };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "삭제", event: "click", handler: processDelete1 };
        gw_com_module.eventBind(args);
        //----------
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_모델", element: "삭제", event: "click", handler: processDelete1 };
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_도면", element: "추가", event: "click", handler: processAdd };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_도면", element: "삭제", event: "click", handler: processDelete1 };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_도면", element: "저장", event: "click", handler: processSave };
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_PJT", element: "추가", event: "click", handler: processAdd };
        gw_com_module.eventBind(args);
        var args = { targetid: "lyrMenu_PJT", element: "삭제", event: "click", handler: processDelete1 };
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_첨부", element: "추가", event: "click", handler: processAdd };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_첨부", element: "삭제", event: "click", handler: processDelete1 };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_첨부", element: "저장", event: "click", handler: processSave };
        gw_com_module.eventBind(args);
        //=====================================================================================
        //var args = { targetid: "lyrMenu_evl", element: "평가", event: "click", handler: processAppraise };
        //gw_com_module.eventBind(args);
        //=====================================================================================
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_APART", element: "추가", event: "click", handler: processAdd };
        gw_com_module.eventBind(args);
        var args = { targetid: "lyrMenu_APART", element: "삭제", event: "click", handler: processDelete1 };
        gw_com_module.eventBind(args);
        var args = { targetid: "lyrMenu_APART", element: "조회", event: "click", handler: processList };
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_BPART", element: "추가2", event: "click", handler: processAdd };
        gw_com_module.eventBind(args);
        var args = { targetid: "lyrMenu_BPART", element: "추가", event: "click", handler: processAdd };
        gw_com_module.eventBind(args);
        var args = { targetid: "lyrMenu_BPART", element: "삭제", event: "click", handler: processDelete1 };
        gw_com_module.eventBind(args);
        var args = { targetid: "lyrMenu_BPART", element: "조회", event: "click", handler: processList };
        gw_com_module.eventBind(args);
        //=====================================================================================
...
//before event bind by KYT 2021-05-25
...
//------
function processAppraise(param) {
// add by kyt 2021-05-12
...
//add 2021-05-19 by KYT


    var dataType = (param.data_tp == undefined) ? "ECO" : param.data_tp; // Set File Data Type
