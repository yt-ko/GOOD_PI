//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// Description : 연구소 설비 실적 외 등록 => 설비 가동 실적 등록
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// 주요 수정 부문 : processFileList, processFileUpload, grdData_FileA
...
var gw_job_process = {
    ...
    UI: function () {
        ...
        gw_com_module.formCreate(args);
        //=====================================================================================
        // Changed by JJJ 21.06.03 : grdData_FileA -> grdData_FileA, DLG_FILE_ZFILE_V -> SYS_File_Edit
   //     var args = {
   ...
   //     };
        ...
        var args = {
            target: [
                ...
                { type: "GRID", id: "grdData_FileA", offset: 8, min: true }
            ]
        };
        //-----------------------
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "frmOption", element: "실행", event: "click", handler: processFileList };
        gw_com_module.eventBind(args);
        //=====================================================================================
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_FileA", element: "추가", event: "click", handler: processFileUpload };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_FileA", element: "삭제", event: "click", handler: processFileDelete };
        gw_com_module.eventBind(args);
        //---------- Changed by JJJ 21.06.03 : download -> _download , 
...
function processLink(param) {
	...
	if ( param.object == "grdData_Main" ) {
		args = {
            ...
            handler_complete: processFileList
		};
	}
    else if (param.object == "grdData_FileA") processFileList( param );
	else return;
...
// ref : grdData_FileA, row click event, processFileListComplete, msg_openedDialogue, msg_closeDialogue
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//------ 파일 리스트 조회
...
*/
    var dataType = (param.data_tp == undefined) ? "EOM-DOWN" : param.data_tp; // Set File Data Type
    var objID = (param.obj_id == undefined) ? "grdData_FileA" : param.obj_id; // Set File Data Type
    var dataKey = gw_com_api.getValue("frmData_Sub", 1, "issue_id");
...
*/
    // Check Updatable
    if (!checkManipulate({ objid: "frmData_Sub", row: 1, grid: false, itself: false })) return;
...
*/
    ...
    var dataType = "EOM-DOWN";    // Set File Data Type
...
streamProcess = function (param) {
    ...
    switch (param.ID) {
        ...
        // Changed by JJJ 21.06.03 -> msg_closeDialogue 로 변경
        ...
        case gw_com_api.v_Stream.msg_closeDialogue: { 
            ...
            // File Upload : Added by JJJ 21.06.03
