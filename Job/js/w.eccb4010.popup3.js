...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_MODEL", query: "w_eccb4010_popup2_1", title: "적용 모델",
            caption: true, height: 90, show: true, selectable: true, number: true, key: true, multi: true, checkrow: true,
            element: [
                { header: "제품유형", name: "prod_type_nm", width: 100, align: "center" },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_PART", query: "w_eccb4010_popup2_2", title: "파트 목록", scroll: true,
            caption: true, height: 150, show: true, selectable: true, number: true, key: true, dynamic: true, //multi: true, checkrow: true,
            editable: { master: true, bind: "edit_yn", focus: "part_cd", validate: true },
            element: [
                {
                    header: "품번", name: "part_cd", width: 180,
                    editable: { type: "text", maxlength: 50, validate: { rule: "required" } }
                },
                {
                    header: "품명", name: "part_nm", width: 390,
                    editable: { type: "text", maxlength: 200 }
                },
                {
                    header: "규격", name: "part_spec", width: 390,
                    editable: { type: "text", maxlength: 200 }
                },
        ...
        var args = {
            target: [
                { type: "GRID", id: "grdList_MODEL", offset: 8 },
...
function informResult(param) {
    ...
    var ids = gw_com_api.getSelectedRow("grdList_MODEL", true);
    if (ids.length == 0 || ids == null) {
        gw_com_api.messageBox([{ text: "적용 모델이 선택되지 않았습니다." }]);
        return false;
    }
    ...
    if (row > 0) {
        ...
        $.each(ids, function () {
            data.push({
                eco_no: v_global.data.eco_no,
                part_tp: v_global.data.part_tp,
                cust_nm: gw_com_api.getValue("grdList_MODEL", this, "cust_nm", true),
                prod_type_nm: gw_com_api.getValue("grdList_MODEL", this, "prod_type_nm", true),
                cust_dept_nm: gw_com_api.getValue("grdList_MODEL", this, "cust_dept_nm", true),
                cust_proc_nm: gw_com_api.getValue("grdList_MODEL", this, "cust_proc_nm", true),
                root_no: gw_com_api.getValue("grdList_MODEL", this, "root_seq", true),
                root_seq: gw_com_api.getValue("grdList_MODEL", this, "model_seq", true),
        ...
        case gw_com_api.v_Stream.msg_openedDialogue:
            {
                ...
                if (param.data.edit) {
                    ...
                    gw_com_api.hide("lyrMenu_조회");
                    var args = {
                        targetid: "grdList_PART", edit: true,
                        data: [
