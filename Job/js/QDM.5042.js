...
var gw_job_process = {
    ...
    ready: function () {
        ...
        var args = {
            request: [
				...
				{ type: "INLINE", name: "집계기준",
				    data: [ { title: "수량", value: "Q" }, { title: "건수", value: "C" } ]
				},
    ...
    UI: function () {
                ...
                row: [
                    {
                        element: [
                            ...
                            { name: "charge_cs", label: { title: "구매요청 부품 만 :" },
                                title: "구매요청 부품 만 조회", value: 1,
				    ...
				    { element: 
				    	[
				            ...
				            { name: "duty_cd", label: { title: "귀책구분 :" },
				                editable: { type: "select",
				                    data: { memory: "귀책구분", unshift: [{ title: "전체", value: "%"}] }
				                }
				            },
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "EHM_5042_M_1", title: "부품 교체 현황",
            height: 201,
            show: true,
            dynamic: true,
            key: true,
            element: [
				{ header: "AS관리번호", name: "issue_no", width: 100, align: "center" },
				{
				    header: "고객사",
				    name: "cust_nm",
				    width: 80,
				...
				{ header: "발생구분", name: "issue_type", width: 80, align: "center" },
				{
				    header: "원인부품",
				    name: "apart",
				    width: 200,
				...
				{ header: "부품코드", name: "bpart_cd", width: 80, align: "center" },
				{ header: "교체부품", name: "bpart", width: 200, align: "left" },
				{
				    header: "수량",
				    name: "change_qty",
				    width: 50,
				...
				{ header: "ERP 출고일", name: "erp_dt", width: 80, align: "center", mask: "date-ymd" },
        ...
        //=====================================================================================
        var args = { targetid: "lyrChart_현황", query: "EHM_5042_S_1",
            show: true,
            format: {
    ...
    var args = {
        source: { type: "FORM", id: "frmOption", hide: true,
            element: [
				...
				{ name: "charge_cs", argument: "arg_charge_cs" }
			],
            remark: [
