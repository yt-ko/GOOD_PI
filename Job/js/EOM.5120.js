...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "frmOption", type: "FREE", title: "조회 조건",
            ...
            content: { row: [
                    { element: [
				            ...
				            { name: "chart", label: { title: "Chart Type :" },
        ...
        //==== Main Grid
        var args = { targetid: "grdData_Main", query: "EOM_5120_M_1", title: "설비별 가동율",
            caption: true, width: 550, height: 259, pager: false, show: true,
            element: [
				{ header: "설비", name: "category", width: 165, align: "center" },
				{ header: "예약시간", name: "value1", width: 60, align: "center" },
				{ header: "가동시간", name: "value2", width: 60, align: "center" },
				{ header: "다운시간", name: "value3", width: 60, align: "center" },
				{ header: "예약대비", name: "rate1", width: 60, align: "center" },
				{ header: "실가동율", name: "rate2", width: 60, align: "center" },
				{ header: "다운율", name: "rate3", width: 60, align: "center" },
        ...
        //==== Main Chart
        var args = { targetid: "lyrChart_Main", query: "EOM_5120_M_1", title: "설비별 가동율", show: true,
        ...
        //==== Sub Grid
        var args = { targetid: "grdData_Sub", query: "EOM_5120_S_1", title: "모듈별 가동율",
            caption: true, width: 550, height: 259, pager: false, show: true,
            element: [
				{ header: "설비", name: "category", width: 165, align: "center" },
				{ header: "예약시간", name: "value1", width: 60, align: "center" },
        ...
        //==== Sub Chart
        var args = { targetid: "lyrChart_Sub", query: "EOM_5120_S_1", title: "모듈별 가동율", show: true,
            format: { view: "1", rotate: "0", reverse: "1" },
