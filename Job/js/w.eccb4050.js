...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_모델", element: "추가", event: "click", handler: processButton };
        gw_com_module.eventBind(args);
        //----------
        //var args = { targetid: "lyrMenu_모델", element: "복사", event: "click", handler: processButton };
        //gw_com_module.eventBind(args);
        ////----------
        //var args = { targetid: "lyrMenu_모델", element: "수정", event: "click", handler: processButton };
        //gw_com_module.eventBind(args);
        ////----------
        var args = { targetid: "lyrMenu_모델", element: "삭제", event: "click", handler: processButton };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_모델", element: "통보", event: "click", handler: processButton };
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_PJT", element: "합의요청", event: "click", handler: processButton };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_PJT", element: "요청취소", event: "click", handler: processButton };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_PJT", element: "추가", event: "click", handler: processButton };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_PJT", element: "삭제", event: "click", handler: processButton };
        gw_com_module.eventBind(args);
        //=====================================================================================
                ...
                case "추가":
                    {
                        if (param.object == "lyrMenu") {
                            ...
                            var dataType = "ECA";    // Set File Data Type
                            var dataKey = gw_com_api.getValue("frmData_내역", "selected", "eca_no", true);   // Main Key value for Search
                            var dataSeq = gw_com_api.getValue("frmData_내역", "selected", "1");   // Main Seq value for Search
...
function processFileList(param) {
    ...
    var dataType = (param.data_tp == undefined) ? "ECA" : param.data_tp; // Set File Data Type
...
function processRetrieve(param) {
    ...
    gw_com_module.objRetrieve(args);
    processFileList({
        data_key: gw_com_api.getValue("frmData_내역", 1, "eca_no")
    });
}
//----------
