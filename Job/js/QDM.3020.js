...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "frmOption", type: "FREE", title: "조회 조건",
            ...
            content: { row: [
                    ...
                    { element: [        
                        ...
                        { name: "part_change", value: "1", label: { title: "부품교체 :" },
                          editable: { type: "select",
        ...
        //grdData_현황
        var args = { targetid: "grdData_현황", query: "QDM_3020_M_1", title: "월별 발생 건수",
            caption: true, width: 220, height: 400, pager: false, show: true,
            element: [
				{ header: "발생년월", name: "category", width: 70, align: "center" },
				{ header: "건수", name: "value", width: 50, align: "center" },
				{ header: "부품수량", name: "value2", width: 50, align: "center" },
				...
				{ name: "part_change", hidden: true },
				{ name: "endstat", hidden: true },
        ...
        //grdData_상세
        var args = { targetid: "grdData_상세", query: "QDM_3020_S_1", title: "상세 내역",
...
//        gw_com_module.gridCreate(args);
        //lyrChart_통계
        var args = { targetid: "lyrChart_통계", query: "QDM_3020_M_1", show: true,
