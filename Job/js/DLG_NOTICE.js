...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            caption: false, width: "100%", show: true, selectable: true,
            content: {
                width: { field: "100%" }, height: 520,
                row: [
                    {
                        element: [
                            { name: "memo_html", format: { type: "html", height: 520, top: 5 } }
                        ]
                    }
                ]
            }
        ...
        var args = {
            ...
            caption: true, height: 55, pager: false, number: true, show: true, selectable: true,
            element: [
