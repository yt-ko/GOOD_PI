...
var gw_job_process = {
    ...
    ready: function () {
        ...
        function start() {
            ...
            v_global.logic.mng = gw_com_api.getPageParameter("mng");
            ...
            v_global.logic.mng = (gw_com_module.Decrypt(v_global.logic.mng) == "Y");
            processRetrieve({});
            //----------
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_MAIN", query: "DLG_ECM_MNG_1", type: "TABLE", title: "",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_SUB", query: "DLG_ECM_MNG_2", title: "계약자",
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_MAIN2", query: "DLG_ECM_MNG_1", type: "TABLE", title: "계약 내용",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_DOC", query: "DLG_ECM_MNG_3", title: "계약문서",
            height: "100%", show: true, caption: true, pager: false, selectable: true, number: true,
            element: [
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_REF", query: "DLG_ECM_MNG_4", title: "연관 계약서",
            height: "100%", show: true, caption: true, pager: false, selectable: true, number: true,
            element: [
                {
        ...
        var args = {
            target: [
                ...
                { type: "GRID", id: "grdList_REF", offset: 8 }
            ]
        };
        //----------
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "grdList_REF", grid: true, element: "doc_no", event: "click", handler: processLink };
        gw_com_module.eventBind(args);
        //=====================================================================================
