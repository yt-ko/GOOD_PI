...
function informResult(param) {
    ...
    var args = {
        ID: gw_com_api.v_Stream.msg_selectedEVLItem,
        data: {
            ...
            ecr_dt: gw_com_api.getCellValue("GRID", "grdData_현황", "selected", "ecr_dt"),
            ecr_dept: gw_com_api.getCellValue("GRID", "grdData_현황", "selected", "ecr_dept_nm"),
            ecr_emp: gw_com_api.getCellValue("GRID", "grdData_현황", "selected", "ecr_emp_nm")
        }
    };
    gw_com_module.streamInterface(args);
...
streamProcess = function (param) {
    ...
    switch (param.ID) {
        case gw_com_api.v_Stream.msg_selectEVLItem:
            {
                var retrieve = true;
