...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "grdData_FileA", grid: true, element: "_download", event: "click", handler: processItemclick };
        gw_com_module.eventBind(args);
...
/*                        gw_com_module.downloadFile(args);*/
                        ...
                        var args = {
                            ...
                            source: {
                                ...
                                argument: [
                                    { name: "arg_issue_no", value: gw_com_api.getValue("grdData_발생정보", "selected", "issue_no", true) }
                                ]
                            },
                            option: [
