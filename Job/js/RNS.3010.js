...
var gw_job_process = {
    ...
    ready: function () {
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        //----------
        var args = { type: "PAGE", page: "RNS_2012", title: "Rule/SOP 상세보기", width: 1000, height: 630 };
    ...
    UI: function () {
                        ...
                        element: [
                            ...
                            },
                            {
                                ...
                                editable: {
                                    ...
                                    change: [{ name: "rns_tp", memory: "분류", unshift: [{ title: "전체", value: ""}], key: ["rns_fg"] }] }
                            },
                            {
                                name: "rns_tp", label: { title: "분류 :" },
                                editable: { type: "select", data: { memory: "분류", unshift: [{ title: "전체", value: "" }], key: ["rns_fg"] } }
                            }
                        ]
                    },
                    {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_MAIN", query: "RNS_3010_1", title: "Rule & SOP",
            caption: true, height: 550, show: true, selectable: true, number: true,
            element: [
                { header: "장비군", name: "dept_area_nm", width: 80 },
                { header: "구분", name: "rns_fg_nm", width: 80, align: "center" },
        ...
        //=====================================================================================
        //var args = {
        //    targetid: "grdData_SUB", query: "RNS_3010_2", title: "개정이력",
        //    caption: true, height: 100, show: true, selectable: true, number: true,
        //    element: [
        //        { header: "장비군", name: "dept_area_nm", width: 100 },
        //        { header: "분류", name: "rns_tp_nm", width: 100 },
        //        { header: "문서번호", name: "rns_no", width: 100, align: "center" },
        //        { header: "문서명", name: "rns_nm", width: 250 },
        //        { header: "개정일자", name: "rev_date", width: 80, align: "center", mask: "date-ymd" },
        //        { header: "개정번호", name: "rev_no", width: 60, align: "center" },
        //        { header: "진행상태", name: "astat_nm", width: 80, hidden: true },
    ...
    if (param.object == "grdData_MAIN") {
        ...
        var args = {
            source: {
                ...
                argument: [
                    { name: "arg_auth_id", value: gw_com_module.v_Session.USR_ID }
                ]
            },
            target: [
