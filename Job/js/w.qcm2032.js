...
var gw_job_process = {
        ...
        var args = {
            request: [
				...
				},
				{
				    ...
				    param: [
                        { argument: "arg_hcode", value: "IQDM05" }
                    ]
				}
			],
            starter: start
    ...
    procedure: function () {
        ...
        function rowselected_grdData_발생정보(ui) {
            ...
            var target = (gw_com_api.getValue("grdData_발생정보", "selected", "rcode", true) == "PM")
                    ? "제조" : "AS";
            switch (target) {
                case "AS":
                    {
                ...
                case "mstat":
                    {
                        if (ui.value.current == "1"
                            || ui.value.current == "2") {
                            gw_com_api.setValue(ui.object, ui.row, "memp", gw_com_module.v_Session.EMP_NO, true);
                            //gw_com_api.setValue(ui.object, ui.row, "memp_nm", gw_com_module.v_Session.USR_NM, true);
                        }
                        else {
                            gw_com_api.setValue(ui.object, ui.row, "memp", "", true, true);
                            //gw_com_api.setValue(ui.object, ui.row, "memp_nm", " ", true);
                        }
                    }
                    break;
            }
