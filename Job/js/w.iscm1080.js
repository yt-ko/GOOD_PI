...
function processCallApp(param) {
    ...
    if (row > 0) {
        var args = "menu_id=SCM_2520&user_id=" + gw_com_module.v_Session.USR_ID + "&p1=MbomB&p2=" + gw_com_api.getValue("grdData_현황", row, "proj_no", true);
        var url = "/App_Setup/MBOM_A/IpsMesMbomA.application?" + args;
