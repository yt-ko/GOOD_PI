    ...
    UI: function () {
        ...
        var args = { targetid: "grdData_현황", query: "QDM_6210_M_2", title: "NCR 발행 내역",
            ...
            element: [
                ...
                { header: "사건사고번호", name: "acdt_no", width: 80, align: "center" },
                ...
                { header: "Line", name: "cust_dept_nm", width: 60 },
                { header: "Process", name: "cust_proc_nm", width: 60 },
                ...
                { header: "원인부위분류", name: "part_tp1", width: 80, hidden: true },
                { header: "원인분류", name: "reason_tp1", width: 80 },
                { header: "원인구분", name: "reason_tp2", width: 80 },
