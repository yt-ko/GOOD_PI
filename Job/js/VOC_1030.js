...
var gw_job_process = {
    ...
    ready: function () {
        ...
        function start() {
            ...
            gw_com_api.setValue("frmOption", 1, "charge_user_nm", gw_com_module.v_Session.USR_NM, false, false, false);
            gw_com_api.setValue("frmOption", 1, "charge_user_id", gw_com_module.v_Session.USR_ID, false, false, false);
            if (gw_com_api.getPageParameter("charge_user") != "") {
                gw_com_api.setValue("frmOption", 1, "charge_user_nm", "", false, false, false);
                gw_com_api.setValue("frmOption", 1, "charge_user_id", gw_com_api.getPageParameter("charge_user"), false, false, false);
            }
            processRetrieve({});
                ...
                row: [
                    ...
                    },
                    {
                        ...
                        element: [
                            ...
                            { name: "charge_dept_nm", hidden: true },
                            { name: "charge_user_nm", label: { title: "담당자 :" },hidden: true },
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "lyrMenu_FILE", element: "추가", event: "click", handler: processFileUpload };
        gw_com_module.eventBind(args);
        //----------
...
//            key: param.key,
//            source: {
//                type: "GRID", id: "frmData_CHARGE", row: "selected",
//                element: [
//                    { name: "voc_no", argument: "arg_voc_no" }
//                ]
//            },
...
function processSave(param) {
    ...
    $.each(ids, function () {
        ...
        if (crud == "U") {
            ...
            // 처리완료일 체크
            var result_stat = gw_com_api.getValue("grdData_CHARGE", this, "result_stat", true);
            var result_date = gw_com_api.getValue("grdData_CHARGE", this, "result_date", true);
            if ((result_stat == "" || result_stat == "020") && result_date != "") {
                gw_com_api.setValue("grdData_CHARGE", this, "result_date", "", true);
            } else if (!(result_stat == "" || result_stat == "020") && result_date == "") {
                gw_com_api.setValue("grdData_CHARGE", this, "result_date", gw_com_api.getDate(), true);
            }
