...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Grid : Main ====
        var args = { targetid: "grdData_현황", query: "EHM_3081_M_1", title: "VOC 등록현황",
            caption: true,
            width: 250,
            height: 200,
            pager: false,
        ...
        //==== Grid : Sub ====
        var args = { targetid: "grdData_상세현황", query: "EHM_3081_S_1", title: "상세 현황",
            caption: true,
            height: 190,
            pager: false,
            show: true, number: true,
        ...
        //==== Chart : Main ====
        var args = { targetid: "lyrChart_통계", query: "EHM_3081_M_1", show: true,
