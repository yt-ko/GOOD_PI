...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        function click_lyrMenu_3_추가(ui) {
            ...
            // set data for "File Upload"
            var dataType = "CRM";    // Set File Data Type
            var dataKey = gw_com_api.getValue("frmData_내역", 1, "ecr_no");   // Main Key value for Search
...
function processFileList(param) {
    ...
    var dataType = (param.data_tp == undefined) ? "CRM" : param.data_tp; // Set File Data Type
...
function processFile(param) {
    ...
    if (param.element == "file_upload") {
        ...
        var args = {
            ...
            page: "SYS_FileUpload", title: "Upload Fils", pageArgs: pageArgs,
            data: v_global.event.file  // reOpen 을 위한 Parameter
        };
