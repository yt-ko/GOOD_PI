...
function informResult(param) {
    ...
    var args = {
        ID: gw_com_api.v_Stream.msg_selectedPart_Stock,
        data: {
            part_cd: gw_com_api.getValue("grdData_자재", "selected", "part_cd", true),
            part_nm: gw_com_api.getValue("grdData_자재", "selected", "part_nm", true),
            part_spec: gw_com_api.getValue("grdData_자재", "selected", "part_spec", true),
            part_unit: gw_com_api.getValue("grdData_자재", "selected", "part_unit", true),
            hold_qty: gw_com_api.getValue("grdData_자재", "selected", "hold_qty", true)
        }
    };
    gw_com_module.streamInterface(args);
...
streamProcess = function(param) {
    ...
    switch (param.ID) {
        case gw_com_api.v_Stream.msg_selectPart_Stock:
            {
                var retrieve = false;
