    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { header: "모듈", name: "eq_module", width: 30, align: "center" },
				{ header: "Run(hr)", name: "run_time", width: 40, align: "right" },
                { header: "Run(%)", name: "run_time_per", width: 40, align: "right" },
				{ header: "Down(hr)", name: "down_time", width: 40, align: "right" },
                { header: "Down(%)", name: "down_time_per", width: 40, align: "right" },
				{ header: "계측(hr)", name: "measure_time", width: 40, align: "right" },
                { header: "계측(%)", name: "measure_time_per", width: 40, align: "right" },
				{ header: "H/W Modify(hr)", name: "modify_time", width: 40, align: "right" },
                { header: "H/W Modify(%)", name: "modify_time_per", width: 40, align: "right" },
				{ header: "Idle(hr)", name: "idle_time", width: 40, align: "right" },
                { header: "Idle(%)", name: "idle_time_per", width: 40, align: "right" },
        ...
        $("#grdData_Main_data").parents('div.ui-jqgrid-bdiv').css("max-height", "250px");
        ...
        var args = {
            ...
            element: [
				...
				{ header: "Run(hr)", name: "run_time", width: 80, align: "right" },
                { header: "Run(%)", name: "run_time_per", width: 80, align: "right" },
				{ header: "Down(hr)", name: "down_time", width: 80, align: "right" },
                { header: "Down(%)", name: "down_time_per", width: 80, align: "right" },
				{ header: "계측(hr)", name: "measure_time", width: 80, align: "right" },
                { header: "계측(%)", name: "measure_time_per", width: 80, align: "right" },
				{ header: "H/W Modify(hr)", name: "modify_time", width: 80, align: "right" },
                { header: "H/W Modify(%)", name: "modify_time_per", width: 80, align: "right" },
				{ header: "Idle(hr)", name: "idle_time", width: 50, align: "right" },
                { header: "Idle(%)", name: "idle_time_per", width: 50, align: "right" },
				{ name: "ymd_fr", hidden: true },
				{ name: "ymd_to", hidden: true },
				{ name: "rcode", hidden: true },
				{ name: "chart", hidden: true }
