...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //    ]
        //};
        // Data Box : Attach File add by kyt 21.06.03
        var args = {
...
function processRetrieve(param) {
    ...
    if (param.file) {
        ...
        args.target = [
         ...
         /* del by kyt 21.06.03 { type: "GRID", id: "grdData_FileA", select: true }*/
        ];
    }
...
function processFileList(param) {
    ...
    */
    ...
    var dataKey = v_global.logic.voc_no;
...
function processFileUpload(param) {
    ...
    v_global.event.data = { data_tp: dataType, data_key: dataKey, data_seq: dataSeq, file_group2: biz_area, file_group3: doc_area,user: gw_com_module.v_Session.USR_ID,}; 
