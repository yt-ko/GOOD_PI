...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            editable: { bind: "select", focus: "file_desc2", validate: true },
            content: {
                height: 25, width: { label: 80, field: 300 },
                row: [
                    {
                        element: [
                            { header: true, value: "Ser. No.", format: { type: "label" } },
                            { name: "file_desc2", editable: { type: "text", width: 98, validate: { rule: "required" } }, width: 100 },
                            { header: true, value: "설명", format: { type: "label" } },
                            { name: "file_desc", editable: { type: "text", width: 310 } }
                        ]
                    }
                ]
            }
                ...
                row: [
                    {
                        ...
                        column: [
                            ...
                            { name: "file_desc2", value: gw_com_api.getValue("frmData_설명", 1, "file_desc2") },
...
function successSave(response, param) {
    ...
    gw_com_api.setValue("frmData_설명", 1, "file_desc2", "");
    v_global.logic.uploaded = true;
