...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "frmOption", type: "FREE", title: "조회 조건",
            ...
            content: { row: [
                    ...
                    { element: [
				            ...
				            { name: "prod_type1", label: { title: "제품분류 :" },
				                editable: { type: "select",
        ...
        var args = {
            targetid: "lyrChart_Main", query: "QDM_5524_C_1", title: "설비 다운 지수", show: true,
        ...
        //==== Sub Grid : 상세현황 ====
        var args = {
            targetid: "grdData_Sub", query: "QDM_5524_S_1", title: "상세 내역", 
            ...
            element: [
				...
				{ header: "Process", name: "cust_proc_nm", width: 80, align: "center" },
				{ header: "고객설비명", name: "cust_prod_nm", width: 100, align: "center" },
				{ header: "제품명", name: "prod_nm", width: 120, align: "center" },
				{ header: "DOWN일자", name: "issue_date", width: 80, align: "center", mask: "date-ymd" },
				{ header: "DOWN시간", name: "down_hours", width: 60, align: "center" },
				{ header: "DOWN구분", name: "issue_tp_nm", width: 60, align: "center" },
				{ header: "DOWN모듈", name: "prod_sub", width: 60, align: "center" },
				{ header: "DOWN사유", name: "rmk", width: 300, align: "left" },
...
function processLinkPage(ui) {
    ...
    if (ui.object = "grdData_Sub") {
        ...
        // Popup Type
        var args = {
            type: "PAGE", page: LinkPage, title: "Down 상세 정보",
