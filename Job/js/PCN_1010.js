...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "grdData_FileA", grid: true, element: "_download", event: "click", handler: processFile };
        gw_com_module.eventBind(args);
        //=====================================================================================
...
function processInsert(param) {
    ...
    if (param.object == "lyrMenu_1") {
        ...
        v_global.event.data = { data_tp: dataType, data_key: dataKey, data_seq: dataSeq };
