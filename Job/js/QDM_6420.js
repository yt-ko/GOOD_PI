...
//                { name: "확인", value: "확인요청", icon: "기타" },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_FileA", query: "SYS_File_Edit", title: "첨부 문서(분석관련 보고서 및 변경점 / 개선사항 자료 첨부)",
            ...
            element: [
                ...
                { header: "등록자", name: "ins_usr_nm", width: 80, align: "center" }, //등록자명 한글표기를 위한
                {
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        var args = { targetid: "grdData_FileA", grid: true, element: "download", event: "click", handler: click_grdData_FileA_down };
        gw_com_module.eventBind(args);
        //----------
        function click_lyrMenu_File1_추가(ui) { processFileUpload(ui); }
        function click_lyrMenu_File1_삭제(ui) { processDelete(ui); }
        function click_grdData_FileA_down(ui) { 
...
function processFileUpload(param) {
    ...
    var dataType = "NCR-RSLT";    // Set File Data Type

    // add by kyt 2021-06-04
    var dataKey = gw_com_api.getValue("grdData_Sub", 1, "rqst_no", true);
    var dataSeq = 0;
...
function processFileList(param) {
    ...
    var dataType = (param.data_tp == undefined) ? "NCR-RSLT" : param.data_tp; // Set File Data Type
