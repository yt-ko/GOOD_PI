...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_DEPT", query: "RNS_2010_DEPT", title: "부서",
            ...
            element: [
                ...
                { header: "부서명", name: "dept_nm", width: 370 },
...
function processSave(param) {
    ...
    $.each(ids, function () {
        if (gw_com_api.getValue("grdList_DEPT", this, "chk", true) == "1")
            auth_id += (auth_id == "" ? "" : ",") + gw_com_api.getValue("grdList_DEPT", this, "dept_cd", true);
    });
    ...
    var args = {
        ...
        input: [
            ...
            { name: "auth_tp", value: "DEPT", type: "varchar" },
