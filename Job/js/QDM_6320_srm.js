...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_Sub", query: "QDM_6320_S_2", title: "담당 부서",
            ...
            element: [
                ...
                { header: "자료제공동의", name: "agree_yn", width: 80, align: "center" },
	            ...
	            row: [
	                ...
	                },
	                {
	                	element: [
		                    ...
		                    { name: "act_user", editable: { type: "text"} },
                            ...
                            { name: "agree_yn", hidden: true, editable: { type: "hidden" } }
		                ]
	                }
	            ]
	        }
	                    ...
	                    element: [
	                        {
	                            ...
	                            format: { type: "textarea", rows: 8, width: 190 },
	                            editable: { type: "textarea", rows: 8, width: 190 }
	                        },
	                        {
                        ...
                        element: [
                            {
                                ...
                                format: { type: "textarea", rows: 8, width: 500 },
                                editable: { type: "textarea", rows: 8, width: 500 }
                            },
                            {
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "적용결과", format: { type: "label" } },
                            {
                                ...
                                format: { type: "textarea", rows: 8, width: 906 }
                            },
                            { name: "rqst_no", hidden: true },
                            { name: "act_seq", hidden: true },
...
function processSave(param) {
    ...
    // 요청상세 및 기술자료제공 동의
    var IsAgree = gw_com_api.getValue("frmData_D1", "selected", "agree_yn");
    if (IsAgree != "Y") {
        var sRqstNo = gw_com_api.getValue("grdData_Sub", "selected", "rqst_no", true);
        var sSuppCd = gw_com_api.getValue("grdData_Sub", "selected", "supp_cd", true);
        var args2 = {
            page: "TDR_NcrAgree",
            param: {
                ID: gw_com_api.v_Stream.msg_openDialogue,
                data: { rqst_no: sRqstNo, supp_cd: sSuppCd, chk_agree: true }
            }
        };
        gw_com_module.dialogueOpen(args2);
        return;
    }
    ...
    switch (param.ID) {
        ...
        case gw_com_api.v_Stream.msg_closeDialogue: {
            ...
            switch (param.from.page) {
                ...
                case "TDR_NcrAgree":
                    if (param.data != undefined && param.data.IsAgree == true) {
                        gw_com_api.setValue("frmData_D1", "selected", "agree_yn", "Y");
                        gw_com_api.setValue("grdData_Sub", "selected", "agree_yn", "Y", true);
                        Agree = true;
                    }
                    break;
            }
            closeDialogue({ page: param.from.page, IsAgree: Agree });
        } break;
    }
