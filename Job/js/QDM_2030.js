...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "reason_cd", label: { title: "시점구분 :" },
                                editable: { type: "select", data: { memory: "시점구분", unshift: [ { title: "전체", value: "" } ] } }
                            },
                            {
                                name: "duty_cd",
                                label: {
                            ...
                            { name: "prod_sub", label: { title: "MODULE :" }, hidden: true },
                            { name: "cust_proc", label: { title: "PROCESS :" }, hidden: true },
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "EHM_2030_M_5", title: "문제 발생 현황",
            ...
            element: [
				...
				{ header: "발생현상", name: "rmk", width: 200, align: "left" },
				...
				{ header: "문제유형", name: "issue_cd", width: 80, align: "center" },
				{ header: "문제유형", name: "issue_tp", width: 80, align: "center" },
				{ header: "시점구분", name: "reason_cd", width: 80, align: "center" },
				{ header: "귀책구분", name: "duty_cd", width: 80, align: "center" },
				{ header: "해당업체", name: "supp_nm", width: 180, align: "left" },
				{ header: "처리자", name: "rslt_emp", width: 70, align: "center" }
			]
        };
        //----------
        ...
        target: [
			{
			    type: "GRID",
			    id: "grdData_현황",
			    query: (v_global.process.param != "") ? "EHM_2030_M_6" : "EHM_2030_M_5",
			    select: true,
			    focus: true
			}
		],
