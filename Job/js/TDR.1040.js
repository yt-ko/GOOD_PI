...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { name: "print", header: "동의서", width: 80, align: "center", format: { type: "link" } }, //, value: "출력"
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_THIRD", grid: true, element: "print", event: "click", handler: processClick };
        gw_com_module.eventBind(args);
        //----------
