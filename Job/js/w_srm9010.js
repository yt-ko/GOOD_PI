                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "addr1", editable: { type: "hidden", width: 697 } },
                            { header: true, value: "회사주소 상세", format: { type: "label" } },
                            { name: "addr2", editable: { type: "hidden", width: 697 } }
                        ]
                    }
                ]
            }
...
function processRetrieve() {
    ...
    if (v_global.data.module == "TDR") gw_com_api.hide("lyrMenu_1", "도장");
        ...
        case gw_com_api.v_Stream.msg_myInformation:
            {
                ...
                v_global.data.module = param.data.module;
                if (v_global.data.module == "TDR") gw_com_api.hide("lyrMenu_1", "도장");
                processRetrieve();
            }
            break;
