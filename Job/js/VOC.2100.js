    ...
    UI: function () {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "upd_dt" },
                            { name: "rcpt_dept", hidden: true, editable: { type: "hidden" } }
                        ]
                    }
                ]
            }
        ...
        var args = {
            ...
            element: [
                ...
                { header: "처리일자", name: "mailsend_dt", width: 160, align: "center", mask: "date-ymd"},
...
function processInform(param) {
    var args = {
        ...
        argument: [
            { name: "voc_no", value: gw_com_api.getValue("frmOption", 1, "voc_no") }
        ],
        input: [
