...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_공지일람", query: "w_sys2034_M_1", title: "공지 일람",
        ...
        var args = {
            ...
            caption: true, height: "100%", pager: true, number: true, show: true, selectable: true,
            element: [
        ...
        var args = {
            ...
            content: {
                width: { field: "100%" }, height: 350,
                row: [
                    {
                        element: [
                            { name: "memo_html", format: { type: "html", height: 350 } }
                        ]
                    }
                ]
            }
