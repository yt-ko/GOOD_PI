...
function informResult(param) {
    ...
    var args = {
        ID: gw_com_api.v_Stream.msg_selectedEmployee_SCM,
        data: {
...
streamProcess = function(param) {
    ...
    switch (param.ID) {
        case gw_com_api.v_Stream.msg_selectEmployee_SCM:
            {
                var retrieve = false;
                if (param.data != undefined) {
                    if (param.data.dept_cd
                        != gw_com_api.getValue("frmOption", 1, "dept_cd")) {
                ...
                if (retrieve)
                    processRetrieve();
                gw_com_api.setFocus("frmOption", 1, "dept_cd");
            }
            break;
