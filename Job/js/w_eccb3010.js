...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { header: "Process", name: "cust_proc", width: 120, align: "center", editable: { type: "hidden" } },
    ...
    procedure: function () {
        ...
        function itemdblclick_frmData_메모A(ui) {
            ...
            processMemo({
                type: ui.type, object: ui.object, row: ui.row, element: ui.element, html: true
            });
        }
        //----------
...
function processMemo(param) {
    ...
    if (param.html) {
        var args = {
            ...
            width: 1000, height: 570, locate: ["center", "bottom"], open: true
        };
        if (gw_com_module.dialoguePrepare(args) == false) {
            var args = {
