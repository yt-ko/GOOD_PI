...
var gw_job_process = {
    ...
    UI: function() {
        ...
        //==== Grid : Main ====
        var args = { targetid: "grdData_부품", query: "w_find_part_spc_M_1", title: "부품",
            caption: false, height: 400, show: true, selectable: true, dynamic: true, key: true,
            element: [
				{ header: "부품코드", name: "part_cd", width: 100, align: "center" },
				{ header: "부품명", name: "part_nm", width: 200, align: "center" },
				{ header: "업체코드", name: "supp_cd", width: 100, align: "center" },
				{ header: "업체명", name: "supp_nm", width: 200, align: "center" },
				{ header: "규격", name: "part_spec", width: 220, align: "center" }
			]
        };
...
function informResult(param) {
    ...
    var args = {
        ...
        data: {
            ...
            supp_nm: gw_com_api.getValue("grdData_부품", "selected", "supp_nm", true),
