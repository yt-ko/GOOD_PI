    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { header: "중요도", name: "doc_level", width: 50, align: "center" },
                { header: "문서구분", name: "doc_class", width: 50, align: "center" },
                { header: "고객사", name: "cust_cd", width: 80, align: "center" },
                { header: "설비유형", name: "prod_tp", width: 150 },
                    ...
                    element: [
                        {
                            ...
                            format: { type: "textarea", rows: 15, width: 300 },
                            editable: { type: "textarea", rows: 15, width: 300 }
                        },
