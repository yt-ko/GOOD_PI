...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Main Grid : VOC 분류별현황 ====
        var args = {
            targetid: "grdData_Main", query: "QDM_5522_M_1", title: "Top3 불량 현황",
            caption: true, width: 300, height: 180, pager: false, show: true,
            element: [
				{ name: "category", header: "Part 명", width: 130, align: "center" },
				{ name: "value", header: "건 수", width: 50, align: "center" },
        ...
        //==== Main Chart : Top3 불량 현황 ====
        var args = {
            targetid: "lyrChart_Main", query: "QDM_5522_C_1", title: "Top3 불량 현황", show: true,
        ...
        //==== Sub Grid : 상세현황 ====
        var args = {
            targetid: "grdData_Sub", query: "QDM_5522_S_1", title: "상세 내역", 
