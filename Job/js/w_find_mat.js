...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        function click_lyrMenu_1_추가(ui) {
            ...
            if (gw_com_module.dialoguePrepare(args) == false) {
                var args = {
                    page: "w_hcem1041",
                    param: {
                        ID: gw_com_api.v_Stream.msg_editMaterial,
                        data: {
                            mat_categorize: mat_categorize
                        }
                    }
                };
        ...
        function click_lyrMenu_1_수정(ui) {
            ...
            else if (gw_com_api.getSelectedRow(source, true).length > 1) {
                gw_com_api.messageBox([
                ...
                if (param.data.key != undefined) {
                    $.each(param.data.key, function () {
                        if (this.QUERY == "w_hcem1041_M_1") {
                            switch (v_global.process.current.tab) {
                                case 1:
                                    this.QUERY = "w_find_mat_1";
                                    break;
                                case 2:
                                    this.QUERY = "w_find_mat_2";
                                    break;
                                case 3:
                                    this.QUERY = "w_find_mat_3";
                                    break;
                                case 4:
                                    this.QUERY = "w_find_mat_4";
                                    break;
                            };
                        }
                    });
        ...
        case gw_com_api.v_Stream.msg_openedDialogue:
            {
                ...
                switch (param.from.page) {
                    case "w_hcem1041":
                        {
                            args.ID = gw_com_api.v_Stream.msg_editMaterial;
