...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //    caption: true, height: 80, show: true, selectable: true, number: true, key: true, //dynamic: true, multi: true, checkrow: true,
        //    element: [
...
function processRetrieve(param) {
    ...
    if (param.item) {
        ...
        var args = {
            ...
            target: [
                { type: "GRID", id: "grdList_MODEL", select: true }
            ],
            key: param.key
        };
        gw_com_module.objRetrieve(args);
...
function informResult(param) {
    ...
    //var row = gw_com_api.getSelectedRow("grdList_MODEL");
    //if (row == null || row < 1) {
    //    gw_com_api.messageBox([{ text: "적용 모델이 선택되지 않았습니다." }]);
    //    return false;
    //}
    //var model = gw_com_api.getRowData("grdList_MODEL", row);
    ...
    if (row > 0) {
        var args = {
            ...
            data: {
                ...
                //prod_type_nm: model["prod_type_nm"],
                //cust_dept_nm: model["cust_dept_nm"],
                //cust_proc_nm: model["cust_proc_nm"],
                //root_no: model["root_seq"],
                //root_seq: model["model_seq"],
