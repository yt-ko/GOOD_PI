...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                //{ name: "추가", value: "고분보 추가/수정", icon: "추가" },   // del by JJ at 2021.04.13
                { name: "닫기", value: "닫기" }
            ]
        };
        ...
        var args = {
            ...
            element: [
                ...
                { header: "원인유형", name: "reason_nm", width: 150 },
                { header: "현상유형", name: "status_tp_nm", width: 150 },
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_현황", grid: true, event: "rowkeyenter", handler: processRowdblclick };
        gw_com_module.eventBind(args);
        //=====================================================================================
        ...
        function processClick(param) {
            ...
            switch (param.element) {
                ...
                case "삭제":
                    {
                        processDelete({ main: true });
                    }
                    break;
                case "저장":
                    {
                        processSave({ main: true });
                    }
                    break;
                case "닫기":
                    {
        ...
        var rqst_no = gw_com_api.getPageParameter("rqst_no");
        if (rqst_no != "") {
            gw_com_api.setValue("frmOption", 1, "rqst_no", rqst_no);
            retrieve = true;
        }
        if (retrieve)
            processRetrieve({});
