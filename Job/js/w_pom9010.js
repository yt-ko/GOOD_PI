        ...
        var args = {
            ...
            element: [
                ...
                },
                {
                    ...
                    editable: { type: "hidden", validate: { rule: "required", message: "사용자명" } }
                },
                {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "zip_no", editable: { type: "hidden" } },
                            { header: true, value: "대표자명", format: { type: "label" } },
                            { name: "prsdnt_nm", editable: { type: "hidden" } }
                        ]
                    },
                    {
                        element: [
    ...
    procedure: function () {
        ...
        function click_lyrMenu_1_로그인(ui) {
            ...
            if (row > 0) {
                ...
                var url = getSRMURL({});
                url = url + "/Master/GoodPLM.aspx?app=srm&user_id=" + gw_com_api.getValue("grdData_협력사", row, "login_id", true) + "&passwd=" + gw_com_api.getValue("grdData_협력사", row, "user_pw", true);
