...
function informResult(param) {
    ...
    var args = {
        ID: gw_com_api.v_Stream.msg_selectedPart_MRP,
        data: {
...
streamProcess = function (param) {
    ...
    switch (param.ID) {
        case gw_com_api.v_Stream.msg_selectPart_MRP:
            {
                var retrieve = false;
