            ...
            request: [
				{
				    ...
				    param: [
                        { argument: "arg_hcode", value: "SPC010" }
                    ]
				},
				{
				    type: "PAGE", name: "품목분류", query: "DDDW_CM_CODE",
				    param: [
                        { argument: "arg_hcode", value: "SPC020" }
                    ]
				},
                {
                    type: "INLINE", name: "보기",
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				...
				{ header: "Part 분류", name: "part_grp", width: 240, align: "left",
        ...
        var args = {
            ...
            element: [
            	{ header: "Part No.", name: "part_no", width: 150, align: "center" },
            	{ header: "Part Name", name: "part_nm", width: 150, align: "left" },
            	{ header: "검사항목", name: "part_nm", width: 150, align: "left" },
            	{ header: "Normal Value", name: "part_nm", width: 150, align: "center" },
            	{ header: "USL Value", name: "part_nm", width: 150, align: "center" },
            	{ header: "LSL Value", name: "part_nm", width: 150, align: "center" },
            	{ header: "공차", name: "part_nm", width: 150, align: "center" },
            	{ header: "종류", name: "part_nm", width: 150, align: "center" }
			]
        };
        //----------
        gw_com_module.gridCreate(args);
