...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "lyrMenu_FileA", type: "FREE",
            element: [
				{ name: "추가", value: "추가" },
				{ name: "삭제", value: "삭제" }
			]
                ...
                row: [
                    {
                        element: [
                            ...
                            {
                                name: "nt_tp",
                                editable: { type: "select", data: { memory: "공지구분" },
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_MemoA", query: "w_sys2030_S_2", type: "TABLE", title: "공지내용",
    ...
    procedure: function () {
        ...
        */
        ...
        var args = {
            ...
            element: "닫기",
            event: "click",
            handler: click_lyrMenu_Top_닫기
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_FileA", element: "추가", event: "click",
            handler: click_lyrMenu_FileA_추가
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_FileA", element: "삭제", event: "click",
            handler: click_lyrMenu_FileA_삭제
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_FileA", grid: true, element: "_download", event: "click",
        ...
        /*
        //----------
        function click_lyrMenu_Top_대상자(ui) {
        }
        */
        //----------
        function click_lyrMenu_Top_저장(ui) {

            processSave({});

        }
        //----------
        function click_lyrMenu_Top_닫기(ui) {
        ...
        //----------
        function click_lyrMenu_FileA_추가(ui) {
                ...
                var args = {
                    ...
                    param: {
                        ...
                        data: {
                            ...
                            key: "",
                            seq: gw_com_api.getValue("frmData_MainA", "selected", "nt_seq")
                        }
                    }
                };
        ...
        //----------
        function click_lyrMenu_FileA_삭제(ui) {
            if (!checkManipulate({})) return;
            var args = {
                targetid: "grdData_FileA",
                row: "selected"
...
function checkCRUD(param) {
    ...
    return gw_com_api.getCRUD("frmData_MainA");
...
streamProcess = function (param) {
    ...
    switch (param.ID) {
                    ...
                    case "w_upload_notice":
                        {
                            ...
                            args.data = {
                                user: gw_com_module.v_Session.USR_ID,
                                key: "",
                                seq: gw_com_api.getValue("frmData_MainA", 1, "nt_seq")
                            };
                        }
                        break;
                }
        ...
        case gw_com_api.v_Stream.msg_uploaded_NOTICE:
            {
                var args = {
                    source: { type: "FORM", id: "frmData_MainA",
                        element: [
