...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_FILE", grid: true, element: "download", event: "click", handler: processFileDownload };
        gw_com_module.eventBind(args);
        //----------
        ...
        case gw_com_api.v_Stream.msg_closeDialogue:
            {
                ...
                switch (param.from.page) {
                    ...
                    case "SYS_FileUpload":
                        {
                            processFileList({ data_key: gw_com_api.getValue("frmData_SETUP_D", 1, "setup_no") });
                        }
                        break;
                }
            }
