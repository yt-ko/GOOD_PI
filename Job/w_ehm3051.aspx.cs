...
public partial class Job_w_ehm3051 : System.Web.UI.Page
{
    ...
    public static string Update(cSaveData DATA)
    {
        ...
        try
        {
            ...
            for (int iAry = 0; iAry < DATA.getSize(); iAry++)
            {
                ...
                {
                    if (DATA.getObject(iAry).getQuery() == "w_ehm3051_M_2"
                        && DATA.getObject(iAry).getRow(iRow).getType() == typeQuery.INSERT)
                    {
                        ...
                        try
                        {
                            ...
                            objProcedure.objCmd.Parameters.AddWithValue("@KeyType", "QCF");
