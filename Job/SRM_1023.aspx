<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true" CodeFile="SRM_1023.aspx.cs" Inherits="Job_SRM_1023" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/SRM_1023.js?ver=181024" type="text/javascript"></script>
    ...
    <form id="frmServer" runat="server">
        <div id="lyrControl">
            <dx:ASPxHtmlEditor ID="ASPxctlHTML" runat="server" Width="100%" ClientInstanceName="ctlHTML"
                ClientVisible="False" Height="470px" EnableTheming="True" Theme="Default" OnHtmlCorrecting="ASPxHtmlEditor1_HtmlCorrecting">

                <StylesDocument Font-Names="맑은 고딕" />
                <ClientSideEvents HtmlChanged="function(s, e) {
gw_com_DX.event_htmlchanged(s);	
}" Init="function(s, e) {
	processInit({});
}" />
                <Toolbars>
                ...
                <SettingsDialogs>
                    <InsertImageDialog ShowMoreOptionsButton="False">
                        <SettingsImageUpload UploadFolder="~/Files/EDIT_FILES/images/" UploadFolderUrlPath="~/Files/EDIT_FILES/images/">
                        </SettingsImageUpload>
