<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="TDR_1020.aspx.cs" Inherits="Job_TDR_1020" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/TDR_1020.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrMenu_SUB" align="right" style="margin-top: 6px;">
    </div>
    <div id="grdData_SUB">
    </div>
    <div id="lyrMenu_DETAIL1" align="right" style="margin-top: 6px;">
    </div>
