<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true" 
    CodeFile="SRM_OpenSrc_Edit.aspx.cs" Inherits="Job_SRM_OpenSrc_Edit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <script src="js/SRM_OpenSrc_Edit.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    <form id="frmData_SubD" action=""></form>
    <form id="frmData_MainA" action=""></form>
    <form id="frmData_SubA" action=""></form>
    <form id="frmData_SubB" action=""></form>
    <form id="frmData_SubF" action=""> </form>
    <form id="frmData_SubC" action=""></form>
    <form id="frmData_SubE" action=""></form>
