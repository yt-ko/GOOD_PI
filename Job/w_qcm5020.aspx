...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData_2" runat="Server">
    ...
    <div id="lyrChart_발생통계">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="210px" Width="670px"
            ...
            <seriesserializable>
                <cc1:Series ArgumentDataMember="category" Name="Series 1" ValueDataMembersSerializable="value" LegendTextPattern="{A}:{V}">
                    <viewserializable>
                        <cc1:PieSeriesView RuntimeExploding="False">
                        </cc1:PieSeriesView>
                    </viewserializable>
                    <labelserializable>
                        <cc1:PieSeriesLabel Font="맑은 고딕, 8pt" LineVisibility="True" Position="Inside">
                            <fillstyle>
                                <optionsserializable>
