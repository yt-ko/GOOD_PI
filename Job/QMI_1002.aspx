<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="QMI_1002.aspx.cs" Inherits="JOB_QMI_1002" %>

<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <link id="style_theme_tab" href="" rel="stylesheet" type="text/css" />
    <script src="js/QMI_1002.js" type="text/javascript"></script>
...
<asp:Content ID="Content5" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrMenu_LEND" align="right"></div>    
    <div id="grdData_LEND"></div>
