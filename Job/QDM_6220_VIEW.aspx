...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/QDM_6220_VIEW.js?ver=190911" type="text/javascript"></script>
...
<asp:Content ID="Content9" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <form id="frmRoot_SUB_AS" action=""></form>
    <form id="frmRoot_SUB_PO" action=""></form>
    <form id="frmRoot_SUB_QD" action=""></form>
    <div id="grdRoot_DETAIL_AS"></div>
    <div id="grdRoot_DETAIL_PO"></div>
    <div id="grdRoot_DETAIL_QD"></div>
    <form id="frmRoot_DETAIL" action=""></form>
    <div id="grdRoot_DETAIL2_AS"></div>
    <div id="grdRoot_DETAIL2_PO"></div>
    <div id="grdRoot_DETAIL2_QD"></div>
    <div id="grdRoot_DETAIL3_AS"></div>
    <div id="grdRoot_DETAIL3_PO"></div>
    <div id="grdRoot_DETAIL3_QD"></div>
