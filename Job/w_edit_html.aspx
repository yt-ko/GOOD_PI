...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/w_edit_html.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrControl">
        <dx:ASPxHtmlEditor ID="ASPxctlHTML" runat="server" Width="690px" ClientInstanceName="ctlHTML"
...
<ClientSideEvents HtmlChanged="gw_com_DX.event_htmlchanged"></ClientSideEvents>
            ...
            <ValidationSettings InvalidUrlErrorText="URL 혹은 파일이 유효하지 않습니다." GeneralErrorText="네트웍 에러가 발생하여 전송할 수 없습니다." NotAllowedFileExtensionErrorText="해당하는 파일의 확장자는 허용되지 않습니다." MaxFileSizeErrorText="파일 사이즈가 최대 사이즈를 초과하였습니다." MultiSelectionErrorText="업로드할 파일을 찾을 수 없습니다."></ValidationSettings>
            </SettingsImageUpload>
            </InsertImageDialog>
            </SettingsDialogs>
