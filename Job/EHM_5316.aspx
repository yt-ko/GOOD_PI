...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/EHM_5316.js" type="text/javascript"></script>
...
<asp:Content ID="Content4" ContentPlaceHolderID="objContentData" runat="Server">
    <form id="frmServer" runat="server">
        <table width="100%" border="0" cellpadding="1" cellspacing="0" style="margin: 0; margin-top: 2px; padding: 0; white-space: nowrap;">
            ...
            <tr>
                <td width="100%" valign="top" style="padding-top: 8px; padding-left: 5px; padding-right: 2px;">
                    <div id="grdData_분류2">
                    </div>
                </td>
                <td valign="middle" style="padding-top: 8px; padding-left: 2px; padding-right: 5px;">
                    <div id="lyrChart_분류2">
                        <dxchartsui:WebChartControl ID="ctlChart_2" runat="server" Height="220px" Width="800px"
                            ...
                            <Legend Visibility="False"></Legend>
                            <Titles>
                                <cc1:ChartTitle Text="Rev별 교체 갯수" />
                            </Titles>
                        </dxchartsui:WebChartControl>
