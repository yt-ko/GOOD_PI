...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/EOM_5170.js" type="text/javascript"></script>
            ...
            <tr>
                <td valign="top" style="padding-left: 5px; padding-right: 5px;">
                    <div id="lyrChart_5">
                        ...
                        <asp:SqlDataSource ID="ctlDB_5" runat="server" ConnectionString="<%$ ConnectionStrings:PLMDB %>"></asp:SqlDataSource>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign="top" style="padding-left: 5px; padding-right: 5px;">
                    <div id="lyrChart_6">
                        ...
                        <asp:SqlDataSource ID="ctlDB_6" runat="server" ConnectionString="<%$ ConnectionStrings:PLMDB %>"></asp:SqlDataSource>
                    </div>
                </td>
            </tr>
            <tr>
