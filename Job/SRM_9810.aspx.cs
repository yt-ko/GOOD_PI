...
public partial class JOB_SRM_9810 : System.Web.UI.Page
{
    ...
    public static string Update(cSaveData DATA)
    {
        ...
        try
        {
            ...
            #region Customize.
            //---------------------------------------------------------------------------
            if (DATA.getFirst().getQuery() == "SRM_9810_1" && DATA.getFirst().getFirst().getType() == typeQuery.INSERT)
            {
                ...
                try
                {
                    ...
                    objProcedure.objCmd.Parameters.AddWithValue("@KeyType", "SRM_PIC");
