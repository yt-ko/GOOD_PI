...
public partial class JOB_QDM_6620 : System.Web.UI.Page
{
    ...
    public static string Update(cSaveData DATA)
    {
        ...
        try
        {
            ...
            #region Customize.
            //---------------------------------------------------------------------------
            if (DATA.getFirst().getQuery() == "QDM_6620_1"
                && DATA.getFirst().getFirst().getType() == typeQuery.INSERT)
            {
                ...
                try
                {
                    ...
                    objProcedure.objCmd.Parameters.AddWithValue("@KeyType", "ACDT");
                ...
                DATA.setValues("acdt_no", strKey);
                DATA.setValues("data_key", strKey);
            }
            //---------------------------------------------------------------------------
