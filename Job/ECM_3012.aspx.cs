...
public partial class Job_ECM_3012 : System.Web.UI.Page
{
    ...
    protected void ctlUpload_FileUploadComplete(object sender, DevExpress.Web.FileUploadCompleteEventArgs e)
    {
        ...
        try
        {
            ...
            e.CallbackData = strID + "@" + strName + "@" + strType + "@" + strPath + "@" + ((DevExpress.Web.ASPxUploadControl)sender).ClientInstanceName; //id, file, ext, path, option
        }
        catch (Exception ex)
        {
