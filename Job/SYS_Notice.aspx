<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page.master" AutoEventWireup="true"
    CodeFile="SYS_Notice.aspx.cs" Inherits="JOB_SYS_Notice" %>
<%-- Head --%>
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <link id="style_theme_tab" href="" rel="stylesheet" type="text/css" />
    <script src="js/SYS_Notice.js" type="text/javascript"></script>
    <script type="text/javascript"> $(function () { gw_job_process.ready(); }); </script>
</asp:Content>
<%-- Body --%>
