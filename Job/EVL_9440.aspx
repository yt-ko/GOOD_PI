<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Control_7.master" AutoEventWireup="true"
    CodeFile="EVL_9440.aspx.cs" Inherits="JOB_EVL_9440" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/EVL_9440.js" type="text/javascript"></script>
                        ...
                        <diagramserializable>
                            <cc1:RadarDiagram DrawingStyle="Polygon">
                                <axisy>
                                    ...
                                    <visualrange auto="False" maxvalueserializable="1" minvalueserializable="0" AutoSideMargins="False" SideMarginsValue="0" />
                                    <wholerange auto="False" maxvalueserializable="1" minvalueserializable="0" AutoSideMargins="False" SideMarginsValue="0" />
                                </axisy>
                            </cc1:RadarDiagram>
                        </diagramserializable>
                        <legend alignmenthorizontal="Right" alignmentvertical="TopOutside" direction="LeftToRight" visibility="True"></legend>
