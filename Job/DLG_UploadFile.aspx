<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="DLG_UploadFile.aspx.cs" Inherits="Job_DLG_UploadFile" Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/DLG_UploadFile.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrServer" class="form_3">
        <dx:ASPxUploadControl ID="ctlUpload" runat="server" ClientInstanceName="ctlUpload"
            OnFileUploadComplete="ctlUpload_FileUploadComplete" OnFilesUploadComplete="ctlUpload_FilesUploadComplete" UploadMode="Auto" Width="100%" CancelButtonSpacing="2px"
            ShowProgressPanel="True">
            <ValidationSettings FileDoesNotExistErrorText="파일이 존재하지 않습니다." GeneralErrorText="파일 업로드 중에 에러가 발생하였습니다."
                MaxFileSize="524288000" MaxFileSizeErrorText="파일 크기는 500M Byte를 넘을 수 없습니다." 
                NotAllowedFileExtensionErrorText="첨부하신 파일의 확장자는 허용되지 않습니다.">
                <ErrorStyle Wrap="False" />
            </ValidationSettings>
            <CancelButton Text="취소">
            </CancelButton>
            <ClientSideEvents FilesUploadComplete="function(s, e) { e.handler_success = successUpload; gw_com_DX.event_fileuploadcomplete(e); }" />
    ...
    <div style="margin-top: 10px; margin-left: 10px;">
        * 파일 크기는 500M Byte를 넘을 수 없습니다.<br />
        &nbsp;&nbsp;(500M Byte를 넘을 경우 장시간 로딩 후 에러가 발생할 수 있으니 꼭 확인하시기 바랍니다.)
    </div>
</asp:Content>
