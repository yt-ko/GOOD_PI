...
var gw_com_module = {
            ...
            case "FREE":
                {
                    ...
                    $.each(args.content.row, function (i) {
                        ...
                        $.each(this.element, function (j) {
                            ...
                            // 전체 컬럼에 ReadOnly 적용 added by JJJ at 2021.09.14
                            if (args.editable != undefined && args.editable.readonly && this.editable != undefined)
    ...
    gridCreate: function (args) {
        ...
        */
        ...
        //if (args.editable != undefined) {
        content = content +
                "<form" + " id='" + args.targetid + "_form'" + " action = ''>";
        //}
        content = content +
            "<table" +
                " id='" + args.targetid + "_data'" +
        ...
        $.each(args.element, function (i) {
            ...
            var edit = (this.editable != undefined) ? this.editable.type : false;
            // 전체 컬럼에 ReadOnly 적용
            if (args.editable != undefined && args.editable.readonly) edit = false; // added by JJJ at 2021.09.14
        ...
        $.each(args.target, function (i) {
            ...
            if (this.type == "FORM") {
                ...
                if ($("#" + this.id).attr("html")) {
                    var param = { targetid: this.id, url: this.url, params: data.query, query: this.query,
