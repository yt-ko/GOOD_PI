...
//				Referred to jQuery validation v1.7 by Jörn Zaefferer
...
$.extend($.validator, {
	...
	messages: {
		...
		url: "유효한 URL이 아닙니다.",
		date: "유효한 날짜가 아닙니다.",
		dateISO: "유효한 날짜가 아닙니다.",
		number: "Please enter a valid number.",
		digits: "숫자만 입력 가능합니다.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Please enter the same value again.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.validator.format("{0}자 이하로 입력해 주세요."),
		minlength: $.validator.format("최소한 {0}자 이상 입력해 주세요."),
		rangelength: $.validator.format("Please enter a value between {0} and {1} characters long."),
		range: $.validator.format("{0}와 {1} 사이로 입력해 주세요."),
		max: $.validator.format("{0}보다 같거나 작아야 합니다.."),
		min: $.validator.format("{0}보다 같거나 커야 합니다.")
	},
	...
	prototype: {
		...
		elements: function() {
			...
			var targetobj = "#" + this.currentForm.id;
			var element = $(targetobj).find(":input[id!='']");
		...
		findByName: function( id ) {
			...
			return $(document.getElementsByName(id)).map(function(index, element) {
