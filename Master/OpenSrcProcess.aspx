<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Biz.master" AutoEventWireup="true"
    CodeFile="OpenSrcProcess.aspx.cs" Inherits="Master_OpenSrcProcess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objMasterHead" runat="Server">
    ...
    <script src="js/master.OpenSrc.js" type="text/javascript"></script>
...
<%--                        <td width="100%" align="right" style="padding-right: 2px;">
                            ...
                            <img id="imgManual" src="../style/images/master/main_top_manual.png" alt="STIMS 매뉴얼" style="cursor: pointer;" onclick="window.open('/Files/Manual/GW_Masual_기술자료제공(IPS).pdf');" />
                                    ...
                                    <td valign="top">
                                        <div class="workarea_bg">
                                            ...
                                            <div id="lyrAdd">
                                                ...
                                                <!-- Notice Start -->
                                                <%--<div id="lyrNotice" style="width: 472px; float: left; overflow: hidden; margin-top: 200px; margin-left: 2px;">
                                                    <table border="0" width="100%" cellpadding="2" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table id="tblNotice" border="0" cellpadding="1" cellspacing="2" style="margin: 0; padding: 0;">
                                                                </table>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <!-- Notice End -->
                                                <!-- 매뉴얼 시작-->
<%--                                                <div id="right_image_area" style="width: 720px; float: right; overflow: hidden; margin-top: 200px; margin-right: 1px;">
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="left">
                                                                <button id="btnTdrRqst" style="border: 0; margin: 0; padding: 0; background-color: Transparent; cursor: pointer;">
			                                                        <img src="../style/images/master/main_stims_rqst.png" border="0" alt="기술자료 요청현황"/>
                                                                </button>
                                                            </td>
                                                            <td align="left">
                                                                <button id="btnTdrEdit" style="border: 0; margin: 0; padding: 0; background-color: Transparent; cursor: pointer;">
			                                                        <img src="../style/images/master/main_stims_edit.png" border="0" alt="기술자료 요청등록"/>
                                                                </button>
                                                            </td>
                                                            <td align="right">
                                                                <img id="img4" src="../style/images/master/main_stims_manual.png" alt="STIMS 매뉴얼" style="cursor: pointer;" onclick="window.open('/Files/Manual/GW_Masual_기술자료제공(IPS).pdf');" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>--%>
