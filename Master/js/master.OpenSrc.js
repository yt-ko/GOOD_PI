...
//----------
var v_openMenu = { menu_id: gw_com_api.getPageParameter("menu"), id: "New", key: "0" };
if (v_openMenu.menu_id == "New") {
    v_openMenu.menu_id = "SRM_OpenSrc_Process";
}
else {
    v_openMenu.id = gw_com_api.getPageParameter("id");
    v_openMenu.key = gw_com_api.getPageParameter("key");
}
...
var gw_job_process = {
    ...
    before: function () {
        ...
        //----------
        var args = { type: "PAGE", page: "MsgProcess", path: "../Master/", title: "System Message", width: 420, height: 130 };
    ...
    ready: function () {
        ...
        //0. Main Image
        $(".workarea_bg").css("background-image", "url(/style/images/master/main_osm.jpg)");
        ...
        function successSession(data) {
            var lang = gw_com_api.getPageParameter("lang");
            if (lang != "") v_Session.CUR_LANG = lang;
            ...
            var args = [
                { DATA: ["SRM_OpenSrc_Process", gw_com_langs.getLangs("서비스 안내"), "SRM_OpenSrc_Process", "WIN", "1", "1", "", 0, ""] },
                { DATA: ["SRM_OpenSrc_Agree", gw_com_langs.getLangs("개인정보 처리 방침"), "SRM_OpenSrc_Agree", "WIN", "1", "1", "", 0, ""] },
                { DATA: ["SRM_OpenSrc_Edit", "", "SRM_OpenSrc_Edit", "WIN", "1", "1", "", 0, ""] }
            ];
            if (v_openMenu.menu_id != "SRM_OpenSrc_Process") {
                args.push({ DATA: ["SRM_OpenSrc_List", gw_com_langs.getLangs("신규거래제안 이력"), "SRM_OpenSrc_List", "WIN", "1", "1", "", 0, ""] });
            }
            successMenu(args);
        ...
        function invalidSession(data) {
            ...
            location.replace("../Master/OpenSrcIntro.aspx" + (param == "" ? "" : "?" + param));
        ...
        function successMenu(data) {
            ...
            if (data == undefined || data.length < 1) {
                alert(gw_com_langs.getLangs("사용 권한이 없습니다."));
            ...
            var column = {
                menu_id: 0, menu_nm: 1, obj_id: 2, obj_type: 3, exe_yn: 4, level_no: 5, menu_args: 6, child_cnt: 7, menu_pid: 8
            };
            var current = {
                id: "", title: [], url: []
            };
            ...
            if (v_openMenu != undefined && v_openMenu.menu_id != "") {
                if (v_openMenu.obj_id == undefined || v_openMenu.obj_id == "")
                    ...
                    //v_openMenu.menu_args = location.href.slice(location.href.indexOf("?") + 1, location.href.length);
        ...
        //----------
        var args = { targetid: "imgMenu", event: "click", handler: click_imgMenu
        }; gw_com_module.eventBind(args);

        //----------
        var args = { targetid: "btnTdrRqst", event: "click", handler: click_btnTdrRqst };
        gw_com_module.eventBind(args);
        var args = { targetid: "btnTdrEdit", event: "click", handler: click_btnTdrEdit };
        gw_com_module.eventBind(args);
        //----------
        ...
        //----------
        function click_btnTdrRqst() {

            var args = { menu_id: (v_Session.USER_TP == "SUPP" ? "w_srm9020" : "TDR_1010"), frame: true
            }; gw_com_api.launchMenu(args);

        }
        function click_btnTdrEdit() {

            var args = {
                menu_id: (v_Session.USER_TP == "SUPP" ? "w_srm9020" : "TDR_1020"), frame: true
            }; gw_com_api.launchMenu(args);
    ...
    processTab: function (index, title, content, args, menu_id) {
        ...
        if (index == "SRM_OpenSrc_Edit") title = gw_com_langs.getLangs("신규 거래 제안");
        v_Tab.index = index;
        v_Tab.title = title;
