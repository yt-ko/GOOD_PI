...
var gw_job_process = {
    ...
    ready: function () {
        ...
        function successSession(data) {
            ...
            var welcome =
                "<span style='font-family: Verdana; font-weight: bold; border-bottom: 1px solid #777777; color: #777777; vertical-align: middle; '>" +
                v_Session.USR_NM + " " + v_Session.POS_NM + "님 " +
                "STIMS 방문을 환영합니다." +
                "</span>";
            ...
            // 협력사
                ...
                // 공지사항 자동 Popup
                //if (v_openMenu.menu_id == "") { v_Job.openNotice = true; }
                ...
                if (v_Session.USER_TP == "SYS"
                    || v_Session.USR_ID == "youngjun" || v_Session.USR_ID == "tjsong"
                    || v_Session.USR_ID == "jukim03" || v_Session.USR_ID == "jhkim4"
                    || v_Session.USR_ID == "hkim")
                {
                    var args = [
                        { DATA: ["TDR_1010", "기술자료 요청현황", "TDR_1010", "WIN", "1", "1", "", 0, ""] },
                        { DATA: ["TDR_1040", "기술자료 요청등록", "TDR_1020", "WIN", "1", "1", "", 0, ""] },
                        { DATA: ["TDR_1015", "요청 데이터 관리", "TDR_1015", "WIN", "1", "1", "", 0, ""] },
                        { DATA: ["TDR_NcrList", "NCR 기술자료 요청현황", "TDR_NcrList", "WIN", "1", "1", "", 0, ""] }
                    ];
                }
                else {
                    var args = [
