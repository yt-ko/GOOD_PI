...
var gw_job_process = {
    ...
    before: function () {
        ...
        //----------
        var args = { type: "PAGE", page: "MsgProcess", path: "../Master/", title: "PLM Message", width: 420, height: 130 };
    ...
    ready: function () {
        ...
        function invalidSession(data) {
            ...
            location.replace("../Master/SRMIntro.aspx" + (param == "" ? "" : "?" + param));
