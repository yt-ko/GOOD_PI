...
var gw_intro_process = {
    ...
    ready: function(argMenu) {
        ...
        */
        ...
        var args = { targetid: "btnNew", event: "click", handler: click_btnNew };
        gw_com_module.eventBind(args);
        ...
        function click_btnAuth() {
            ...
            //----------
            var query = (location.hostname.split(".")[0].toLowerCase() == "pstims" ? "SRM_AUTH" : "SRM_AUTH");
        ...
        function click_btnNew() {
            //신규가입자용 ID 부여
            gw_com_api.setValue("frmAuth", 1, "login_id", "1234567890");
            gw_com_api.setValue("frmAuth", 1, "login_pw", "1234567890");
            click_btnAuth();
        ...
        function successAuth(data) {
            ...
            if (redirect != "")
                ...
                location.replace(
                    "../Master/TDCProcess.aspx" + (param == "" ? "" : "?" + param)
                );
            }
