<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Biz.master" AutoEventWireup="true"
    CodeFile="srmTDCProcess.aspx.cs" Inherits="srmMaster_TDCProcess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objMasterHead" runat="Server">
    ...
    <script src="js/srmmaster.tdc.js" type="text/javascript"></script>
                                ...
                                <tr>
                                    <td valign="top">
                                        <div class="workarea_bg">
                                            ...
                                            <div id="lyrAdd">
                                                <!-- Notice Start -->
                                                <div id="lyrNotice" style="width: 400px; float: left; overflow: hidden; margin-top: 300px; margin-left: 4px;">
                                                ...
                                                <!-- Notice End -->
                                                <!-- 매뉴얼 시작-->
                                                <div id="right_image_area" style="width: 280px; float: right; overflow: hidden; margin-top: 300px; margin-right: 4px;">
                                                    <table border="0" width="100%" cellpadding="2" cellspacing="0">
                                                        <tr>
                                                            <td align="right">
