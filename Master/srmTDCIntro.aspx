<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SRM.master" AutoEventWireup="true"
    CodeFile="srmTDCIntro.aspx.cs" Inherits="srmMaster_TDCIntro" %>

<asp:Content ID="objManagerHead" ContentPlaceHolderID="objMasterHead" runat="Server">
    <script src="js/srmintro.tdc.js" type="text/javascript"></script>
...
<table border="0px" width="1200px" style="padding: 0; margin: 0; white-space: nowrap; overflow: hidden;">
<tr style="height: 600px; vertical-align: top"><td>
		                ...
		                <div class="divTableRow">
                            <div class="divTableCell">
                                <div class="divTable">
                                    <div class="divTableBody">
                                        <div class="divTableRow">
						<div class="divTableCell" style="width: 100px;"><a style="text-decoration: none;" href="#" target="_blank"><span style="font-family: Verdana; font-size: 14px; font-weight: bold;">HOME</span></a></div>
